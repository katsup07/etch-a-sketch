...
const sizeButtonPlus = document.querySelector('.size-plus');
const sizeButtonMinus = document.querySelector('.size-minus');
...
const { width, height } = canvas; // Destructuring const width = canvas.width and const height = canvas.height;
...
function changeSize() {
  ...
  labelSize.textContent = `Dot Size: ${ctx.lineWidth}`;
}
